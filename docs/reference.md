...
The public API lives at the module root (`github.com/go-ruby-augeas/augeas`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `augeas`, while the surface follows
...
```go
import "github.com/go-ruby-augeas/augeas"
```
...
- **[pkg.go.dev/github.com/go-ruby-augeas/augeas](https://pkg.go.dev/github.com/go-ruby-augeas/augeas)**

The module's [README](https://github.com/go-ruby-augeas/augeas#readme) carries worked
